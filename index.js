let text_content = `
Hace muchos, muchos años en una ciudad de Irán llamada Wirani, hubo un rey que gobernaba con firmeza su territorio. Había acumulado tanto poder que nadie se atrevía a cuestionar ninguna de sus decisiones: si ordenaba alguna cosa, todo el mundo obedecía sin rechistar, porque aquel que se atreviera a desobedecer dicha orden podría llegar a ser esclavizado, torturado o en el peor de los casos asesinado.
...
document.addEventListener("DOMContentLoaded", ()=> {
  document.querySelector(".content p").innerHTML = text_content;
})